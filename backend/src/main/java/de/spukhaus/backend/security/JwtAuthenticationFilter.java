...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private final SpukhausUserDetailsService userDetailsService;

    public JwtAuthenticationFilter(JwtService jwtService, SpukhausUserDetailsService userDetailsService) {
        ...
        if (header != null && header.startsWith("Bearer ")) {
            ...
            if (userId.isPresent() && SecurityContextHolder.getContext().getAuthentication() == null) {
                try {
                    ...
                    // ungültiger/abgelaufener Token -> Request bleibt unauthentifiziert
                }
            }
        }
